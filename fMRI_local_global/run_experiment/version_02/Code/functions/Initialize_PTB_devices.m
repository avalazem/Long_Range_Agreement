...
handles.rendershift=4; % in pixels, specific for text renderer 1. 
handles.distance=195;% temporary
handles.screenwid=69.84; % temporary
handles.screenpx=1920; % temporary
...
handles.devicenumtrigger=devicenumtrigger;
handles.devicenum=devicenum;
handles.devicenumkey=devicenumkey;
