...
% Runs the training block that includes 5 example sentences.
% Used at the beginning of the experiment to get the subjects
...
for trial=1:length(training_words)
    ...
    WaitSecs('UntilTime', text_onset + params.SOA_visual);
