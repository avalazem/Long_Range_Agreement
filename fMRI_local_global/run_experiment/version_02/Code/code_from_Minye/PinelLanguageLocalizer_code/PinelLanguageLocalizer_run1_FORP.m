...
audiodeviceindex=audiodevices(locationaudio(logicalaudio)).DeviceIndex;% temporary
% audiodeviceindex=-1;

%% load stim list file (cells of strings)
% Randomize during the exp: block order
load('stimlistall_PinelLanguage_resampled.mat');% 84 stim lists
...
%              htstim=RectHeight(Screen('TextBounds',w,textstim));
             ...
             Screen('DrawText',w,textstim,cx-wtstim/2,cy+htstim/2,stimcolor,[],1); % allignment
